...
flags.DEFINE_string("output_path", 'CLaMM_dataset',"output image path")
flags.DEFINE_integer("sample_size", 1000,"How much sample you want to output")
flags.DEFINE_integer("options", 1,"output option")
flags.DEFINE_string("dataset", "CLaMM_Training_Data_Set", "The name of dataset CLaMM_Training_Data_Set")
flags.DEFINE_string("input_fname_pattern", "*.jpg", "Glob pattern of filename of input images [*]")
flags.DEFINE_string("checkpoint_dir", "checkpoint", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("sample_dir", "samples256", "Directory name to save the image samples [samples]")
