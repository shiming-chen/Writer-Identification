...
imdb = load('./HistoricalWI_Train_binary.mat') ;
imdb = imdb.imdb;
% -------------------------------------------------------------------------
...
opts.train.expDir = './data/res52_drop0.75_HistoricalWI_binary_E500_F1024';
opts.train.derOutputs = {'objective', 1} ;
%opts.train.gamma = 0.9;
opts.train.momentum = 0.9;
%opts.train.constraint = 100;
opts.train.learningRate = [0.1*ones(1,200),0.01*ones(1,300)] ;
